...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    ...
    /* START DEBUGING SECTION */
    console.log(this.checkoutFormGroup.get('customer').value);
    console.log("The email address is " + this.checkoutFormGroup.get('customer').value.email);
    console.log("The shipping address country is " + this.checkoutFormGroup.get('shippingAddress').value.country.name);
    console.log("The shipping address state is " + this.checkoutFormGroup.get('shippingAddress').value.state.name);
    /* END DEBUGGING DECTION */
  }


  resetCart() {
    // Reset shopping cart data
    this.cartService.cartItems = []; // Set cart to an empty array
    this.cartService.totalPrice.next(0); // Set subscriber to zero
    this.cartService.totalQuantity.next(0); // Set subscriber to zero
